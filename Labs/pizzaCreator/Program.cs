...
namespace PizzaCreator
{
    class Program
    {
        ...
        public static bool aBacon = false, Ham = false, Pepperoni = false, Sausage = false, BlackOlives = false, Mushrooms = false, Onions = false, Peppers = false, Traditional = false, Garlic = false, Oregano = false, Regular = false, Extra = false, TakeOut = false, Delivery = false;
        ...
        private static void DisplayData()
        {
            ...
            if (aBacon || Ham || Sausage || Pepperoni)
            {
        ...
        private static void MOdification()
        {
            ...
            Console.WriteLine("Press 1 to add Peporani ($0.75) and anyother key to skip it.Your Previous Option is:" + ((Pepperoni) ? "Yes add Bacon" : "No Don't add"));
            String Pepporoni = Console.ReadLine();
            if (Pepporoni == "1")
            {
                if (Pepperoni)
                { price -= 0.75; }
            ...
            bool isSauseChoosenCorrectly = false;
            do
            {
            ...
            } while (!isCheeseChoosenCorrectly);




            Console.WriteLine("Almost DOne!! NOw choose from the following");
            bool isDeliveryChoosenCorrectly = false;
            do
            {
                ...
                if (Devlivery == "T")
                {
                    ...
                    TakeOut = true;
                    price += 0;
                    isDeliveryChoosenCorrectly = true;
                } else if (Devlivery == "D")
                {
                    if (Delivery)
                    { price -= 2.50; }
            ...
            } while (!isDeliveryChoosenCorrectly);
        ...
        private static void NewOrder()
        {
            ...
            bool isSizeChoosenCorrectly = false;
            do
            {
                Console.WriteLine("Press S for small ($5) \nPress M for medium ($6.25)\nPress L for Large($8.75)\n");
                String SizeOfPizza = Console.ReadLine().ToUpper();
